...
namespace CabViewerSDK.TextEditor
{
    partial class FindForm
    {
        ...
        {
            this.btClose = new DarkButton();
            this.btFindNext = new DarkButton();
            this.tbFind = new DarkTextBox();
            this.cbRegex = new DarkCheckBox();
            this.cbMatchCase = new DarkCheckBox();
            this.label1 = new DarkLabel();
            this.cbWholeWord = new DarkCheckBox();
            this.SuspendLayout();
            // 
            // btClose
            // 
            ...
            this.btFindNext.Text = "下一个";
            this.btFindNext.UseVisualStyleBackColor = true;
            this.btFindNext.AutoSize = true;
            this.btFindNext.Click += new System.EventHandler(this.btFindNext_Click);
            // 
            // tbFind
            // 
            this.tbFind.Location = new System.Drawing.Point(50, 12);
