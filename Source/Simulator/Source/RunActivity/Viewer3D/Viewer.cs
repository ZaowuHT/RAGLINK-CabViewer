...
namespace Orts.Viewer3D
{
    public class Viewer
    {
        ...
        public void Update(RenderFrame frame, float elapsedRealTime)
        {
            ...
            // CabViewer Area Start  

            TrainMethods.UpdateTrains(PlayerTrain, PlayerLocomotive, Simulator.Trains);
            TimetableMethods.UpdateTimetable(PlayerTrain, Simulator.Trains);
