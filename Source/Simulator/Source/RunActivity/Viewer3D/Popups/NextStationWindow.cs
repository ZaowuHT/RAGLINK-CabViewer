...
namespace Orts.Viewer3D.Popups
{
    public class NextStationWindow : Window
    {
        ...
        public Label StationPlatform;
        public Label CurrentDelay;

        public Label StationPreviousName;
        public Label StationPreviousDistance;
        public Label StationPreviousArriveScheduled;
        public Label StationPreviousArriveActual;
        public Label StationPreviousDepartScheduled;
        public Label StationPreviousDepartActual;

        public Label StationCurrentName;
        public Label StationCurrentDistance;
        public Label StationCurrentArriveScheduled;
        public Label StationCurrentArriveActual;
        public Label StationCurrentDepartScheduled;

        public Label StationNextName;
        public Label StationNextDistance;


        public Label StationNextArriveScheduled;
        public Label StationNextDepartScheduled;

        public Label Message;

        public Train playerTrain;
        public TTTrain playerTimetableTrain;
        ...
        public override void PrepareFrame(ElapsedTime elapsedTime, bool updateFull)
        {
            ...
            if (updateFull)
            {
                ...
                playerTrain = Owner.Viewer.Simulator.PlayerLocomotive.Train;
                ...
                {
                    playerTimetableTrain = playerTrain as TTTrain;
