...
namespace CabViewerSDK.Docking
{
    ...
    [ToolboxBitmap(typeof(resfinder), "CabViewerSDK.Docking.DockPanel.bmp")]
    ...
    public partial class DockPanel : Panel
    {
        ...
        public void SetPaneIndex(DockPane pane, int index)
        {
            ...
            if (oldIndex == -1)
                throw(new ArgumentException(CabViewerSDK.Properties.DockingStrings.DockPanel_SetPaneIndex_InvalidPane));

            if (index < 0 || index > Panes.Count - 1)
                if (index != -1)
                    throw(new ArgumentOutOfRangeException(CabViewerSDK.Properties.DockingStrings.DockPanel_SetPaneIndex_InvalidIndex));
        ...
        internal Form ParentForm
        {
            get
            {
                if (!IsParentFormValid())
                    throw new InvalidOperationException(CabViewerSDK.Properties.DockingStrings.DockPanel_ParentForm_Invalid);
