    ...
    public class DockContentHandler : IDisposable, IDockDragSource
    {
        ...
        public DockContentHandler(Form form, GetPersistStringCallback getPersistStringCallback)
        {
            if (!(form is IDockContent))
                throw new ArgumentException(CabViewerSDK.Properties.DockingStrings.DockContent_Constructor_InvalidForm, nameof(form));
        ...
        public double AutoHidePortion
        {
            ...
            {
                if (value <= 0)
                    throw (new ArgumentOutOfRangeException(CabViewerSDK.Properties.DockingStrings.DockContentHandler_AutoHidePortion_OutOfRange));
        ...
        public DockAreas DockAreas
        {
            ...
            set
            {
                ...
                if (!DockHelper.IsDockStateValid(DockState, value))
                    throw (new InvalidOperationException(CabViewerSDK.Properties.DockingStrings.DockContentHandler_DockAreas_InvalidValue));
        ...
        public bool IsFloat
        {
            ...
            set
            {
                ...
                if (visibleState == DockState.Unknown)
                    throw new InvalidOperationException(CabViewerSDK.Properties.DockingStrings.DockContentHandler_IsFloat_InvalidValue);
            ...
            set
            {
                ...
                if (value != null)
                {
                    if (value.IsFloat || value.DockPanel != DockPanel)
                        throw new InvalidOperationException(CabViewerSDK.Properties.DockingStrings.DockContentHandler_DockPane_InvalidValue);
                }
        ...
        public DockPane FloatPane
        {
            ...
            set
            {
                ...
                {
                    if (!value.IsFloat || value.DockPanel != DockPanel)
                        throw new InvalidOperationException(CabViewerSDK.Properties.DockingStrings.DockContentHandler_FloatPane_InvalidValue);
                }
        ...
        internal void SetDockState(bool isHidden, DockState visibleState, DockPane oldPane)
        {
            ...
            if (DockPanel == null && visibleState != DockState.Unknown)
                throw new InvalidOperationException(CabViewerSDK.Properties.DockingStrings.DockContentHandler_SetDockState_NullPanel);

            if (visibleState == DockState.Hidden || (visibleState != DockState.Unknown && !IsDockStateValid(visibleState)))
                throw new InvalidOperationException(CabViewerSDK.Properties.DockingStrings.DockContentHandler_SetDockState_InvalidState);
        ...
        public DockState ShowHint
        {
            ...
            set
            {
                if (!DockHelper.IsDockStateValid(value, DockAreas))
                    throw (new InvalidOperationException(CabViewerSDK.Properties.DockingStrings.DockContentHandler_ShowHint_InvalidValue));
        ...
        {
            if (dockPanel == null)
                throw (new ArgumentNullException(CabViewerSDK.Properties.DockingStrings.DockContentHandler_Show_NullDockPanel));
        ...
        public void Show(DockPanel dockPanel, DockState dockState)
        {
            ...
            if (dockState == DockState.Unknown || dockState == DockState.Hidden)
                throw (new ArgumentException(CabViewerSDK.Properties.DockingStrings.DockContentHandler_Show_InvalidDockState));

            if (dockPanel.Theme.GetType() == typeof(DefaultTheme))
                throw new ArgumentException(CabViewerSDK.Properties.DockingStrings.Theme_NoTheme);
        ...
        {
            if (pane == null)
                throw (new ArgumentNullException(CabViewerSDK.Properties.DockingStrings.DockContentHandler_Show_NullPane));

            if (beforeContent != null && pane.Contents.IndexOf(beforeContent) == -1)
                throw (new ArgumentException(CabViewerSDK.Properties.DockingStrings.DockContentHandler_Show_InvalidBeforeContent));
        ...
        public void Show(DockPane previousPane, DockAlignment alignment, double proportion)
        {
            if (previousPane == null)
                throw (new ArgumentException(CabViewerSDK.Properties.DockingStrings.DockContentHandler_Show_InvalidPrevPane));
        ...
        {
            if (panel != DockPanel)
                throw new ArgumentException(CabViewerSDK.Properties.DockingStrings.IDockDragSource_DockTo_InvalidPanel, nameof(panel));
