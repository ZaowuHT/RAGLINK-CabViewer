...
namespace CabViewerSDK.Docking
{
    public class FloatWindow : Form, INestedPanesContainer, IDockDragSource
    {
        ...
        {
            if (dockPanel == null)
                throw(new ArgumentNullException(CabViewerSDK.Properties.DockingStrings.FloatWindow_Constructor_NullDockPanel));
        ...
        {
            if (panel != DockPanel)
                throw new ArgumentException(CabViewerSDK.Properties.DockingStrings.IDockDragSource_DockTo_InvalidPanel, "panel");
