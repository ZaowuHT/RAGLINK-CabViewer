...
namespace CabViewerSDK.Docking
{
    public abstract class DockPaneStripBase : Control
    {
        ...
        internal protected abstract int MeasureHeight();

        internal protected abstract void EnsureTabVisible(IDockContent content);

        internal virtual int HitTest()
        {
            return HitTest(PointToClient(Control.MousePosition));
        }

        internal protected abstract int HitTest(Point point);
        ...
        internal protected virtual Tab CreateTab(IDockContent content)
        {
