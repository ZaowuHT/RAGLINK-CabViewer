...
{
    using CabViewerSDK.DockingTheme.ThemeVS2012;
    ...
    internal class VS2012DockPaneStrip : DockPaneStripBase
    {
        ...
        internal protected override Tab CreateTab(IDockContent content)
        {
        ...
        internal protected override int MeasureHeight()
        {
            if (Appearance == DockPane.AppearanceStyle.ToolWindow)
        ...
        internal protected override void EnsureTabVisible(IDockContent content)
        {
        ...
        internal protected override int HitTest(Point point)
        {
